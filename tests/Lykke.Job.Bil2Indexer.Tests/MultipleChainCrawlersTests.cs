...
//        private InMemoryCrawlersRepository _crawlersRepository;
...
//            _crawlersRepository = new InMemoryCrawlersRepository();
...
//                {
//                    await crawler.ChooseDirectionAsync(a.Block);
//                }
//            };
...
//                    while (true)
//                    {
//                        var expectedBlock = await _crawlersRepository.GetOrDefaultAsync(TODO, r.Id);
...
//                .ToDictionary(
//                    r => r.Id,
//                    r => _crawlersRepository.GetOrDefaultAsync(TODO, r.Id)
